...
progress:function(_273){
	...
	var _276="<div class=\"messager-progress\" align='center'>"+
				"<div class=\"messager-p-msg\" align='center'>"+
					"<table width='100%'>"+
						"<tr>"+
							"<td align='"+(opts.msg==""?"center":"right")+"'>"+
								"<img src='"+ _ctx_ +"/admin/themes/images/loading_3.gif'/>"+
							"</td>"+
							(
									opts.msg==""?"":
										"<td align='left'>"+
											"<div class=\"messager-p-msg\">"+
												"<span style='padding:0px 3px;font-size:12px;'>"+opts.msg+"</span>"+
											"</div>"+
										"</td>"
							)
						"</tr>"+
	...
	//win.find("div.messager-p-msg").html("<img src='"+ _ctx_ +"/admin/themes/images/loading_3.gif'/>"+opts.msg);
...
$.fn.layout.paneldefaults=$.extend({},$.fn.panel.defaults,{region:null,split:false,minWidth:7,minHeight:10,maxWidth:10000,maxHeight:10000});
})(jQuery);
(function($){
function init(_376){
$(_376).appendTo("body");
...
var total = $(_5dd).datagrid("getData").total;
if(_5de){
opts.queryParams=_5de;
}
var _5df=$.extend({},opts.queryParams);
if(opts.pagination){
$.extend(_5df,{page:opts.pageNumber,rows:opts.pageSize, total:total});
}
if(opts.sortName){
...
var wcls=$.data(_725,"treegrid").total;
...
if(opts.pagination){
$.extend(_72a,{page:opts.pageNumber,rows:opts.pageSize, total:wcls});
}
if(opts.sortName){
...
if(!tree){
tree=$("<ul gesoft='"+_857.id+"'></ul>").appendTo(_858);
