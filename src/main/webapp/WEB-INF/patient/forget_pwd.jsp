...
<html>
  ...
  <body class="radial">
	<div class="new_wrapper">
	   <form action="<c:url value='/p/query/goForgetPwd.do'/>" method="post" onsubmit="return funSubmitInfo()" name="inputform" id="inputform">
	    		...
	    		<input type="password" placeholder="新登录密码" class="r_psw btm" name="userPwd" id="userPwd" maxlength="16" />
