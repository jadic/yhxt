  ...
  <head>
	...
	<script type="text/JavaScript">
		$(function(){
			...
			ComDwr.loadDictInfo("credentialType", true, "${nurse.credentialType}", 1);
			ComDwr.loadDictInfo("nationality", true, "${nurse.nationality}", 2);
			ComDwr.loadDictInfo("marriageStatus", true, "${nurse.marriageStatus}", 3);
			ComDwr.loadDictInfo("householdType", true, "${nurse.householdType}", 4);
			ComDwr.loadDictInfo("education", true, "${nurse.education}", 5);
			ComDwr.loadDictInfo("policticsStatus", true, "${nurse.policticsStatus}", 6);
			</c:if>
        ...
        <div class="informationModify_main">
        	<table cellpadding="0" border="0" cellspacing="0" style="font-size: 13px; width: 100%;">
	    		<tr>
	    			...
	    			<td align="left">
	    				<input class="inputMin_informationModify text-input" type="text" id="credentialNo" name="credentialNo" maxlength="50" value="${nurse.credentialNo }">
	    			</td>
	    		</tr>
	    		<tr>
	    			<td align="right" style="padding: 5px 5px 5px 0; width:70px; height: 30px; color: #aeaeae; font-size: 13px;">
	    			...
	    			<td align="left">
	    				<select class="selectMax_informationModify  text-input validate[required]" id="isSoldier" name="isSoldier">
		                    <option value="-1">请选择</option>
			               <option value="0" <c:if test="${nurse.isSoldier == 0}">selected="selected"</c:if>>是</option>
			               <option value="1" <c:if test="${nurse.isSoldier == 1}">selected="selected"</c:if>>否</option>
		               </select>
	    			</td>
	    			<td align="right" style="padding: 5px 5px 5px 0; width:85px; height: 30px; color: #aeaeae; font-size: 13px;">
	    				是否残疾：
	    			...
	    			<td align="left">
	    				<select class="selectMax_informationModify  text-input validate[required]" id="isDisablity" name="isDisablity">
		                    <option value="-1">请选择</option>
			               <option value="0" <c:if test="${nurse.isDisablity == 0}">selected="selected"</c:if>>是</option>
			               <option value="1" <c:if test="${nurse.isDisablity == 1}">selected="selected"</c:if>>否</option>
		               </select>
	    			</td>
	    		</tr>
	    		<tr>
	    			...
	    			<td align="left">
	    				<input class="inputMin_informationModify text-input" type="text" id="height" name="height" value="${nurse.height }" maxlength="3">
	    			</td>
	    			<td align="right" style="padding: 5px 5px 5px 0; width:85px; height: 30px; color: #aeaeae; font-size: 13px;">
	    				体重(kg)：
	    			</td>
	    			<td align="left">
	    				<input class="inputMin_informationModify text-input" type="text" id="weight" name="weight" value="${nurse.weight }" maxlength="3">
	    			</td>
	    		</tr>
	    		<tr>
	    			<td align="right" style="padding: 5px 5px 5px 0; width:70px; height: 30px; color: #aeaeae; font-size: 13px;">
	    			...
	    			<td align="left">
	    				<input class="inputMin_informationModify text-input" type="text" id="nativePlace" name="nativePlace" value="${nurse.nativePlace }" maxlength="80">
	    			</td>
	    		</tr>
	    		<tr>
	    			<td align="right" style="padding: 5px 5px 5px 0; width:70px; height: 30px; color: #aeaeae; font-size: 13px;">
	    		...
	    		<tr>
	    			...
	    			<td align="left" colspan="3">
	    				<input class="inputMin_informationModify text-input" type="text" id="homePhone" name="homePhone" value="${nurse.homePhone }" maxlength="15">
	    			</td>
	    		</tr>
	    		<tr>
	    			<td align="right" style="padding: 5px 5px 5px 0; width:70px; height: 30px; color: #aeaeae; font-size: 13px;">
	    			...
	    			<td align="left" colspan="3">
	    				<input class="inputMax_informationModify text-input" type="text" id="homeAddress" name="homeAddress" value="${nurse.homeAddress }" maxlength="80">
	    			</td>
	    		</tr>
	    	</table>
	    </div>	
