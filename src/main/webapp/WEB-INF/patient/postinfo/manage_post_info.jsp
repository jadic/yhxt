...
<body>
		...
		<div class="account_title" style="background: #ffffff;">
	      <ul>
	        ...
	        <li class="account_titleGray" style="padding-top: 8px; height: 35px;">
	        	<ul>
	        		<li class="select_BPhistory" style="width: 120px; padding-top: 0px; float: right;"><a href="<c:url value='/p/query/mergePost.do'/>" ><img src="<c:url value='/patient/themes/images/btn_post.png'/>"></a></li>
	        	</ul>
	        </li>
	      </ul>
	    </div>
  ...
  <div class="information_modify">
    <div class="information_modify_main" id="main_div">
    	<div class="search" style="padding-top: 7px; padding-bottom: 7px; margin-bottom: 10px;">
    	<form id="inputform" name="inputform" action="<c:url value='/p/query/post.do'/>" method="post">
		    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="display: block; font-size: 15px;">
		    	<tr>
		    		<td align="right" style="padding: 0px 5px 0px 0; width:70px; height: 30px; color: #aeaeae; font-size: 13px;">
	    				标题：
	    			</td>
		    		<td>
		    			<input id="page" name="page" value="${query.page }" type="hidden"/>
		    			<input class="inputMin_informationModify text-input" type="text" id="title" name="title" value="${query.title }">
		    		</td>
		    		<td>
		    		<ul>
