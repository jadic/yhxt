	  		...
	  		<div style="float: right;  height:78px;">
				...
				<div class="njty_menu" id="420000">
					...
					<div id="mm420000" style="width:145px; display: none;">
						<div data-options="iconCls:'icon-27'" onclick="PageMain.funAddPanel('/a/querySport.do','信息查询>> 运动记录');  $('#420000').click()">运动记录</div>
						<div class="menu-sep"></div>
						<div data-options="iconCls:'icon-26'" onclick="PageMain.funAddPanel('/a/queryDiet.do','信息查询>> 饮食记录');  $('#420000').click()">饮食记录</div>
						<div class="menu-sep"></div>
						<div data-options="iconCls:'icon-26'" onclick="PageMain.funAddPanel('/a/queryMentalStatus.do','信息查询>> 心理状态记录');  $('#420000').click()">心理状态记录</div>
						<div class="menu-sep"></div>
