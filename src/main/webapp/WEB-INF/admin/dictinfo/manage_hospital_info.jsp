...
<!--
	$.getScript(_ctx_+"/admin/scripts/dictinfo/manage_hospital_info.js");
//-->
</script>
<div class="easyui-layout" fit="true" id="div_common">
	<div region="north" style="height:57px;" border="false">
		<table cellpadding="0" cellspacing="0"  border="0" style="font-size:12px;width:100%;">
			<tr>
				<td colspan="5" class="njty_btitle" align="left">医院信息管理&nbsp;</td>
			</tr>
			<tr>
				<td class="njty_bg" align="right" style="width: 100px;">医院名称：</td>
		      	...
		      	<td class="njty_bl" colspan="2" style="height:28px;">
			  		<a id="search" href="javascript:void(0)" class="easyui-linkbutton" icon="icon-search" onclick="PageHospital.funSearchInfo()">查询</a>
