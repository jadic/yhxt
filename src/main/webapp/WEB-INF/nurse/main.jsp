      ...
      <div class="index_health_left" id="userdetail" style="display: block;">
        <div class="wInformation">
          <ul id="member_detail">
            ...
            <li class="tGreen"><span id="membername" title="清波卫生27">清波卫生27</span><a title="基本信息" href="/doctor/jsp/doctor/userarchives/userarchives.jsp" target="indexFrame"><img src="/doctor/images/user_list/phone_editor.png"></a></li>
