...
<body>
  ...
  <div class="tab_healthRecords">
	<div class="healthRecords_menu_yuan">
           <ul>
             <li title="生活习惯" class="selected_healthRecords_yuan" ><img src="<c:url value='/nurse/themes/images/habit.png'/>"><span>生活习惯</span></li>
             <li title="家族遗传史"><img src="<c:url value='/nurse/themes/images/family.png'/>"><span>家族遗传史</span></li>
             <li title="当前并发症" style="display: none;"><img src="<c:url value='/nurse/themes/images/cp.png'/>"><span>当前并发症</span></li>
             <li title="疾病史"><img src="<c:url value='/nurse/themes/images/disease.png'/>"><span>疾病史</span></li>
             <li title="高血压专项" style="display: none;"><img src="<c:url value='/nurse/themes/images/bp.png'/>"><span>高血压专项</span></li>
             <li style="margin-right: -25px; display: none;" title="健康检查" style="display: none;"><img src="<c:url value='/nurse/themes/images/health.png'/>"><span>健康检查</span></li>
