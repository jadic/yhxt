			...
			$.ajax({
				...
				success:function(data)
				{
					if(data.success)
					{
						...
						parent.parent.PageMain.funCreateWinInfoNew("#div_win", "<c:url value='/nurse/pages/send_msg_info.jsp'/>", {userId: userId, userNmae:userName, stime:stime, content:content});
					}
				}
			});
		}
...
<body style="background: #ffffff; min-height: 600px;">
	<div class="account" >
		<div class="account_title" >
	      <ul>
	        <li class="account_titleGreen">留言</li>
	        <li class="account_titleGray"></li>
	      </ul>
	    </div>
	</div>    
  <div class="information_modify">
    <div class="information_modify_main" id="main_div">
    	...
    	<form id="inputform" name="inputform" action="<c:url value='/n/search/home.do'/>" method="post">
    			...
    			<input id="senderId" name="senderId" value="${query.senderId }" type="hidden"/>
    			<input id="userId" name="userId" value="${query.userId }" type="hidden"/>
		</form>    
		</div>
