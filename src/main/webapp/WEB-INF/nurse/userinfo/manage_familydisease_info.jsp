  ...
  <head>
	...
	function edit_baseinfo(obj)
	{
		...
		else
		{
			...
			$.ajax({
				url : _ctx_ + "/n/search/modifyFamilyDisease.do?a="+ Math.random(),
				type : 'post',
				dataType : 'json',
				data : 
				{
...
<body style="background: #ededed;">
  <div class="btn_title_informationModify">
          <ul>
            ...
            <li class="tRight"><a href="javascript:void(0)" onclick="edit_baseinfo(this)" tag="false"><img src="<c:url value='/nurse/themes/images/btn_editor.png'/>"></a></li>
          </ul>
        </div>
