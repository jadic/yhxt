  ...
  <head>
	...
	var PageFx = {
			...
			initChart : function()
			{
				...
				PageFx.funSearchAdvice("/n/search/homeAdvice.do?userId=${query.userId}", {adviceType:1});
				PageFx.funSearchAdvice("/n/search/homeAdvice.do?userId=${query.userId}", {adviceType:2});
				PageFx.funSearchAdvice("/n/search/homeAdvice.do?userId=${query.userId}", {adviceType:3});
				PageFx.funSearchAdvice("/n/search/homeAdvice.do?userId=${query.userId}", {adviceType:4});
				
				PageFx.funSearch(0, "/n/search/statBlood.do?userId=${query.userId}");
				PageFx.funSearch(1, "/n/search/statEar.do?userId=${query.userId}");
				PageFx.funSearch(2, "/n/search/statPressure.do?userId=${query.userId}");
				
				PageFx.funSearchAdvice15("/n/search/homeAdvice15.do?userId=${query.userId}", {adviceType:1});
				PageFx.funSearchAdvice15("/n/search/homeAdvice15.do?userId=${query.userId}", {adviceType:2});
				PageFx.funSearchAdvice15("/n/search/homeAdvice15.do?userId=${query.userId}", {adviceType:3});
				PageFx.funSearchAdvice15("/n/search/homeAdvice15.do?userId=${query.userId}", {adviceType:4});
