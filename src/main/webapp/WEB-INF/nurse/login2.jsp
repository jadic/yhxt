...
<html>
  ...
  <body style="padding: 0px; margin: 0px; overflow: hidden;">
	...
	<div style="width:100%; position: absolute; top: 125px; z-index: 1;" id="loginbg">
		<img src="<c:url value='/nurse/themes/images/login_04.png'/>" alt="" style="height: 400px;"/>
  	</div>
  	<div style="width:100%; position: absolute; top: 125px; z-index: 1;" id="logincon">
		<table id="center-table" cellpadding="0" cellspacing="0" style="width: 100%; min-width:904px; height:500px; overflow: hidden;" border="0" >
			<tr>
				<td >&nbsp;</td>
