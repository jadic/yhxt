...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/JavaScript">
		...
		{
			PageMain.funCreateWinInfoNew("#div_win", "<c:url value='/nurse/pages/user_phone_info.jsp'/>", {userId: "${nurse.userId }"});
		}
		...
		function funSavePhotoInfo()
		{
			PageMain.funOpenProgress();
			$.ajax({
				url : _ctx_ + "/n/search/modifyUserPhoto.do?a="+ Math.random(),
				type : 'post',
				dataType : 'json',
				data : 
				{
        ...
        <div class="informationModify_main">
        	<table cellpadding="0" border="0" cellspacing="0" style="font-size: 13px; width: 100%;">
	    		...
	    		<tr>
	    			...
	    			<td align="left" colspan="3">
	    				<textarea class="inputMax_informationModify text-input" style="height: 60px;" id="achievement" name="achievement">${userModel.achievement }</textarea>
	    			</td>
	    		</tr>		
	    	</table>
	    </div>	
