...
<!--
	$(function(){
		...
		$.ajax({
          url : _ctx_ + "/a/activity/queryAssociatedDoctorIds.do?a="+ Math.random(),
          type : 'post',
          dataType : 'json',
          data :{
            "activityId" : PageActivity.mSelDataGrid.id
          },
			...
			<table border="0" cellspacing="0" cellpadding="0" bordercolordark="999999" bordercolorlight="cbe6a1" class="njty_table">
				<tr>
					<td class="njty_bg" align="center" style="width:100%; background: #cccccc;" valign="middle">
						...
						<a class="easyui-linkbutton" iconCls="icon-ok" href="javascript:void(0)" id="btn_01" onclick="PageActivity.funAssociateDoctor()">确定</a>
