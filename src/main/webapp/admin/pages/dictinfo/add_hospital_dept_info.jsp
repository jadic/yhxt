...
<!--
	$(function(){
		...
		{
			PageMain.funSetWinMaxAttr(360, 120, "修改科室信息", "icon-edit");
		}
		else
		{
			PageMain.funSetWinMaxAttr(360, 120, "新增科室信息", "icon-add");		
		}
			...
			<table border="0" cellspacing="0" cellpadding="0" bordercolordark="999999" bordercolorlight="cbe6a1" class="njty_table">
				<tr>
					<td class="njty_bg" align="center" style="width:100%; background: #cccccc;" valign="middle">
						...
						<a class="easyui-linkbutton" iconCls="icon-ok" href="javascript:void(0)" id="btn_01" onclick="PageHospitalDept.funSaveInfo('${param.param1}')">确定</a>
